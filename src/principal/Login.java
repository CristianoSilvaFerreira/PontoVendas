...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usuario.setBackground(new java.awt.Color(128, 128, 128));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, -10, -1, 194));
    ...
    private void setIcon() {
        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/imagens/principal/logomenor.png")));
